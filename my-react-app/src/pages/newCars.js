...
import fuel from "../images/NewCars/fuel-svgrepo-com.png";
import customize from "../images/NewCars/customize-svgrepo-com.png";
import shield from "../images/NewCars/shield.png";
import Layer2 from "../images/NewCars/Layer2.png";
import chooseus_car from "../images/NewCars/chooseus-car.png";
  ...
  return (
    <>
      ...
      <section className="flex w-full  relative justify-center">
        ...
        />
        <div className="w-[90%] max-w-[1800px] mx-auto absolute top-1/2  transform -translate-y-1/2 z-30 text-white text-left">
      ...
      <section className="bg-sky-100">
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="lg:w-[90%] w-[95%] mx-auto grid mx-auto justify-center items-center lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 my-6  gap-x-3 gap-y-5">
      ...
      <section className="w-[90%] my-6 max-w-[1800px] mx-auto">
        <div className="flex justify-center py-4 items-center">
          <h1 className="text-blue-800 border-l-4 border-blue-800 pl-4 lg:text-4xl sm:text-3xl text-xl text-center font-bold">
      ...
      <section className="pt-6">
        <div className="bg-sky-100  my-6">
          <div className="w-11/12 max-w-[1800px] mx-auto flex-col">
      ...
      <section className="w-[90%] max-w-[1800px]  mx-auto">
        <div className="flex justify-center py-4 items-center">
          <h1 className="text-blue-800 border-l-4 border-blue-800 pl-4 lg:text-4xl sm:text-3xl text-xl text-center font-bold">
