...
import Main_img from "../images/ClassicCar/jorgen-hendriksen-M__Ns_mq_94-unsplash.png";
...
import chooseus_car from "../images/ClassicCar/yellowCar.png";
        ...
        <>
                ...
                <section className="flex w-full relative justify-center">
                    ...
                    <div className="w-[90%] mx-auto max-w-[1800px] absolute top-1/2  transform -translate-y-1/2 z-30 text-white text-left">
                        <div className="flex sm:flex-col flex-row fleax-wrap ">
                            <h1 className="md:text-4xl  sm:text-2xl text-sm font-bold">
                                ...
                                <span className="md:text-4xl sm:text-3xl text-sm">
                                    Vintage Beauty - Classic Cars Collection              </span>
                            </h1>
                        </div>
                        <p className="md:text-sm text-xs md:font-medium font-normal py-2">
                            {" "}
                            Welcome users to explore a curated selection of timeless classic cars that embody automotive
