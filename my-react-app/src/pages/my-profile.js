...
function MyProfile() {
    ...
    return (
        <>
            <Nav />
            <div className="md:w-[80%] w-[95%] mx-auto my-10">
                ...
                <div className="lg:w-[50%] sm:w-[70%]">
                    <div className="flex mb-5 justify-between gap-6 items-center">
                        <label
                            htmlFor="fName"
                    ...
                    <div className="flex mb-5 gap-6 justify-between items-center">
                        <label
                            htmlFor="gender"
                            className="w-48 block text-lg text-right whitespace-nowrap font-semibold text-blue-800"
                        >
                ...
                <div className="lg:w-[50%] sm:w-[70%]">
                    <div className=' flex sm:flex-row flex-col my-5 sm:justify-between gap-6'>
                        <div className='mt-6'>
                            <label
                                className="w-48 block text-lg  whitespace-nowrap font-semibold text-blue-800">
                                Linked Accounts</label>
                        </div>
                        <div className='w-full'>
                            <Link
                                to="/"
                                className="sm:min-w-[390px] flex sm:justify-center form-control rounded-lg block w-full my-3 p-3 text-base font-normal leading-6 text-gray-800  border border-blue-800  transition duration-150 ease-in-out"
                            >
                            ...
                            <Link
                                to="/"
                                className="sm:min-w-[390px] flex gap-8 sm:justify-center form-control rounded-lg block w-full my-3 p-3 text-base font-normal leading-6 text-gray-800  border border-blue-800  transition duration-150 ease-in-out"
                            >
                                <div className="w-full flex  items-center">
